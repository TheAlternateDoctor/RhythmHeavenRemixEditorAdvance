    ...
    private fun openPicker() {
        if (!isChooserOpen) {
            GlobalScope.launch {
                ...
                TinyFDWrapper.openFile(Localization["screen.texent.fileChooserTitle"], attemptRememberDirectory(main, PreferenceKeys.FILE_CHOOSER_TEXENT) ?: getDefaultDirectory(), null) { file ->
                    isChooserOpen = false
