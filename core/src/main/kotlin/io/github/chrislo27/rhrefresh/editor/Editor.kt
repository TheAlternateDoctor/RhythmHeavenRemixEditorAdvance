...
import io.github.chrislo27.rhrefresh.editor.CameraBehaviour.FOLLOW_PLAYBACK
import io.github.chrislo27.rhrefresh.editor.CameraBehaviour.PAN_OVER_SMOOTH
import io.github.chrislo27.rhrefresh.editor.ClickOccupation.TrackerResize
import io.github.chrislo27.rhrefresh.editor.action.*
import io.github.chrislo27.rhrefresh.editor.picker.PickerSelection
import io.github.chrislo27.rhrefresh.editor.rendering.*
import io.github.chrislo27.rhrefresh.editor.stage.EditorStage
import io.github.chrislo27.rhrefresh.editor.stage.EditorStage.DirtyType
import io.github.chrislo27.rhrefresh.editor.view.ViewType
import io.github.chrislo27.rhrefresh.entity.Entity
import io.github.chrislo27.rhrefresh.entity.areAnyResponseCopyable
...
import io.github.chrislo27.rhrefresh.entity.model.special.TextureEntity
import io.github.chrislo27.rhrefresh.midi.MidiHandler
import io.github.chrislo27.rhrefresh.modding.ModdingUtils
import io.github.chrislo27.rhrefresh.undoredo.ActionGroup
import io.github.chrislo27.rhrefresh.patternstorage.ClipboardStoredPattern
import io.github.chrislo27.rhrefresh.patternstorage.StoredPattern
import io.github.chrislo27.rhrefresh.patternstorage.toEntityList
...
import io.github.chrislo27.rhrefresh.track.EditorRemix
import io.github.chrislo27.rhrefresh.track.GameSection
import io.github.chrislo27.rhrefresh.track.PlayState.PAUSED
import io.github.chrislo27.rhrefresh.track.PlayState.PLAYING
import io.github.chrislo27.rhrefresh.track.PlayState.STOPPED
import io.github.chrislo27.rhrefresh.track.PlaybackCompletion
import io.github.chrislo27.rhrefresh.track.Remix
import io.github.chrislo27.rhrefresh.track.timesignature.TimeSigValueChange
import io.github.chrislo27.rhrefresh.track.timesignature.TimeSignature
import io.github.chrislo27.rhrefresh.track.timesignature.TimeSignatureAction
import io.github.chrislo27.rhrefresh.track.tracker.Tracker
import io.github.chrislo27.rhrefresh.track.tracker.TrackerAction
...
import io.github.chrislo27.rhrefresh.util.RectanglePool
...
class Editor(val main: RHREfreshApplication, stageCamera: OrthographicCamera, attachMidiListeners: Boolean)
...
//        val ONE_DECIMAL_PLACE_FORMATTER = DecimalFormat("0.0", DecimalFormatSymbols())
    ...
    fun setFileHandles(baseFile: FileHandle) {
        ...
        autosaveFile = baseFile.sibling(baseFile.nameWithoutExtension() + ".autosave.${RHREfresh.REMIX_FILE_EXTENSION}")
    }
    ...
    fun toScaleX(float: Float): Float =
            (float / RHREfresh.WIDTH) * camera.viewportWidth

    fun toScaleY(float: Float): Float =
            (float / RHREfresh.HEIGHT) * camera.viewportHeight
...
//        }
    ...
    fun renderUpdate() {
        ...
        if (remix.playState == PLAYING) {
            ...
            if (RHREfresh.midiRecording && buildingNotes.isNotEmpty()) {
...
//                }
    ...
    private fun resizeCameraToEntityScale(camera: OrthographicCamera) {
        camera.viewportWidth = RHREfresh.WIDTH / ENTITY_WIDTH
        camera.viewportHeight = RHREfresh.HEIGHT / ENTITY_HEIGHT
        camera.update()
    }

    private fun resizeCameraToPixelScale(camera: OrthographicCamera) {
        camera.viewportWidth = RHREfresh.WIDTH.toFloat()
        camera.viewportHeight = RHREfresh.HEIGHT.toFloat()
        camera.update()
    }
