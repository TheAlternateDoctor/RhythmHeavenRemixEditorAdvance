...
class GlassEffect(val main: RHREfreshApplication, val editor: Editor) {
...
"""
    ...
    val shaderCamera: OrthographicCamera = OrthographicCamera(RHREfresh.WIDTH.toFloat(), RHREfresh.HEIGHT.toFloat()).apply {
        setToOrtho(false, viewportWidth, viewportHeight)
    }
    private val bufferA: FrameBuffer? = Try {
        FrameBuffer(Pixmap.Format.RGBA8888, RHREfresh.WIDTH, RHREfresh.HEIGHT, false, true).apply {
