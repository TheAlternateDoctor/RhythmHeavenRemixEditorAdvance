...
class FakeCrashScreen(main: RHREfreshApplication, val throwable: Throwable, val lastScreen: Screen?)
    : ToolboksScreen<RHREfreshApplication, FakeCrashScreen>(main), HidesVersionText {
