...
import io.github.chrislo27.rhrefresh.playalong.PlayalongControls
...
abstract class RhythmGame(val main: RHREfreshApplication) {
    ...
    protected abstract fun _render(main: RHREfreshApplication, batch: SpriteBatch)
    
    open fun render(main: RHREfreshApplication, batch: SpriteBatch) {
        if (disposed) return
        camera.update()
