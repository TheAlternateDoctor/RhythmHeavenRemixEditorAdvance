...
class AssetRegistryLoadingScreen(main: RHREfreshApplication)
    : ToolboksScreen<RHREfreshApplication, AssetRegistryLoadingScreen>(main) {

    private val camera: OrthographicCamera = OrthographicCamera().apply {
        setToOrtho(false, RHREfresh.WIDTH * 1f, RHREfresh.HEIGHT * 1f)
    }
