...
import io.github.chrislo27.rhrefresh.credits.Credits
...
class CreditsScreen(main: RHREfreshApplication)
    : ToolboksScreen<RHREfreshApplication, CreditsScreen>(main) {
    ...
    init {
            ...
            override fun render(screen: CreditsScreen, batch: SpriteBatch, shapeRenderer: ShapeRenderer) {
                shapeRenderer.prepareStencilMask(batch) {
                    ...
                    shapeRenderer.end()
                            ...
                            val multiplier = (Gdx.graphics.height.toFloat() / RHREfresh.HEIGHT)
        ...
        stage.bottomStage.elements += Button(main.uiPalette, stage.bottomStage, stage.bottomStage).apply {
            this.addLabel(TextLabel(palette, this, this.stage).apply {
                ...
                fun update() {
                    this.text = Localization["screen.info.github", RHREfresh.GITHUB]
                }
                update()
                this.fontScaleMultiplier = 0.9f
            })
            this.leftClickAction = { _, _ ->
                Gdx.net.openURI(RHREfresh.GITHUB)
            }
