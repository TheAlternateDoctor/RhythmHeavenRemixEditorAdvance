...
class OnlineCounterScreen(main: RHREfreshApplication, title: String) : ToolboksScreen<RHREfreshApplication, OnlineCounterScreen>(main) {
    ...
    init {
        ...
        request = RHREfreshApplication.httpClient.prepareGet("https://api.rhre.dev:10443/rhre3/live/history")
