...
class PatternDeleteScreen(main: RHREfreshApplication, val editor: Editor, val pattern: FileStoredPattern, val lastScreen: Screen?)
    : ToolboksScreen<RHREfreshApplication, PatternDeleteScreen>(main) {
