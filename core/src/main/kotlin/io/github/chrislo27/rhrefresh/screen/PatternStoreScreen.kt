...
class PatternStoreScreen(main: RHREfreshApplication, val editor: Editor, val pattern: FileStoredPattern?, val entities: List<Entity>?)
    : ToolboksScreen<RHREfreshApplication, PatternStoreScreen>(main) {
