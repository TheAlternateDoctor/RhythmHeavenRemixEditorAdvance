...
class SFXDBLoadingScreen(main: RHREfreshApplication, val nextScreen: () -> ToolboksScreen<*, *>? = {null})
    : ToolboksScreen<RHREfreshApplication, SFXDBLoadingScreen>(main) {
    ...
    override fun render(delta: Float) {
        ...
        if (progress >= 1f && !Toolboks.debugMode) {
            ...
            main.screen = if (next == null) {
                ...
                val nextScreen = if (!main.githubVersion.isUnknown && (RHREfresh.triggerUpdateScreen || RHREfresh.VERSION < main.githubVersion)) {
