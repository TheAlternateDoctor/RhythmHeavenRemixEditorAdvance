...
fun Music.fadeTo(volume: Float, duration: Float, stopIfZero: Boolean = true) {
    ...
    val startSeconds = RHREfreshApplication.instance.secondsElapsed
    fun createRunnable(): Runnable {
        return Runnable {
            val alpha = ((RHREfreshApplication.instance.secondsElapsed - startSeconds) / duration).coerceIn(0f, 1f)
